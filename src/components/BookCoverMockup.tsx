  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute top-0 bottom-0 left-0 w-3.5 bg-gradient-to-r from-black/50 via-black/20 to-transparent pointer-events-none rounded-l-[1px]" />
        ...
        <div className="absolute -right-1.5 top-1 bottom-1 w-2 bg-[#F3EFE8] rounded-r-xs border-r border-[#D8D0C5] shadow-xs flex flex-col justify-between py-1 pointer-events-none opacity-90 transition-all duration-300 group-hover:brightness-105">
